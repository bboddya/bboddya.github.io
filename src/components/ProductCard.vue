                ...
                <div class="product product_horizontal">
                  ...
                  <div class="product_photo">
                    <a href="#" class="url--link product__link">
                      <img
                        :src="`${primaryImageUrl.slice(0, -4)}_220x220_1.jpg`"
                      />
                    </a>
                  </div>
                  ...
                  <div class="product_tags hidden-sm">
                    ...
                    <a
                      v-for="(product, index) in assocProducts.split(';')"
                      :key="index"
                      href="#"
                      class="url--link"
                      >{{ product }},</a
                  ...
                  <div class="product_units">
                    <div class="unit--wrapper">
                      <div
                        class="unit--select"
                        :class="PriceActive ? 'unit--active' : ''"
                        @click.prevent="PriceActive = true"
                      >
                        <p class="ng-binding">За м. кв.</p>
                      </div>
                      <div
                        class="unit--select"
                        @click.prevent="PriceActive = false"
                        :class="PriceActive ? '' : 'unit--active'"
                      >
                  ...
                  <p class="product_price_club_card">
                    ...
                    >
                    <span v-if="PriceActive == true" class="goldPrice">{{
                      priceGoldAlt.toFixed(2)
                    }}</span>
                    <span v-else class="goldPrice">{{
                      priceGold.toFixed(2)
                    }}</span>
                  ...
                  <p class="product_price_default">
                    <span v-if="PriceActive == true" class="retailPrice">{{
                      priceRetailAlt.toFixed(2)
                    }}</span>
                    <span v-else class="retailPrice">{{
                  ...
                  <div class="product__wrapper">
                    <div class="product_count_wrapper">
                      <div class="stepper">
                        <input
                          ...
                          :value="count"
                        />
                        <span @click="count++" class="stepper-arrow up"></span>
                        <span
                          @click="minCount < count ? count-- : minCount"
                    ...
                    >
                      ...
                      <span :data-product-id="productId" class="ng-binding"
                        >В корзину</span
                      >
                    </span>
                  </div>
...
export default {
  name: "ProductCard",
  /* Создан новый массив с параметрами из json файла, которые передаются в верстку */
  props: [
    "code",
    "title",
    "priceGoldAlt",
